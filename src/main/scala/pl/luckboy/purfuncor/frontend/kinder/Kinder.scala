...
object Kinder
{
  ...
  def inferTypeTreeKindsS[T, U, V, E](tree: Tree[T, AbstractTypeCombinator[U, lmbdindexer.TypeLambdaInfo], V])(env: E)(implicit init: Initializer[NoKind, T, AbstractTypeCombinator[U, lmbdindexer.TypeLambdaInfo], E]) =
