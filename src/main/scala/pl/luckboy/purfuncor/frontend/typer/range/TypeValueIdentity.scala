...
case class ExpandedGlobalTypeAppIdentity[+T](loc: T) extends TypeValueIdentity[T]
case class UnexpandedGlobalTypeAppIdentity[+T](loc: T) extends TypeValueIdentity[T]
