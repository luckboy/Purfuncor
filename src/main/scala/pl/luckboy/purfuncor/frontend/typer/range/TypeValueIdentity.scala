...
case class SupertypeExpandedGlobalTypeAppIdentity[+T](loc: T, sym: GlobalSymbol) extends TypeValueIdentity[T]
case class TypeExpandedGlobalTypeAppIdentity[+T](loc: T, sym: GlobalSymbol) extends TypeValueIdentity[T]
