...
case class Let[+T, +U](binds: NonEmptyList[VarBind[T, U]], body: Term[SimpleTerm[T, U]], letInfo: U) extends SimpleTerm[T, U]
...
case class VarBind[+T, +U](name: String, body: Term[SimpleTerm[T, U]], pos: Position)
