...
object BuiltinFunction extends Enumeration
{
  ...
  val DGt = Value("dGt")
  val DGe = Value("dGe")
  val DoubleFromB = Value("doubleFromByte")
  val DoubleFromS = Value("doubleFromShort")
  val DoubleFromI = Value("doubleFromInt")
  val DoubleFromL = Value("doubleFromLong")
  val DoubleFromF = Value("doubleFromFloat")
  // Array
